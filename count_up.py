...
genecount=0
gene_lengths=[] #initially I tried "=0" but then it won't append.
gff = "Escherichia_coli_str_k_12_substr_mg1655.ASM584v2.37.gff3.gz"
with gzip.open(gff, "rt") as fh:
	gff = csv.reader(fh, delimiter="\t")
	for row in gff:
...
percent_coding = float(100* (coding_length/total_genome_length)) #float returns a floating point from a string
